...
export const textStyles: TextStyleEntry[] = [
  ...
  },
  {
    ...
    audit: [],
    mobile: { font: "Inter Tight", size: 16, lineHeight: 24, weight: 400 },
    desktop: { font: "Inter Tight", size: 16, lineHeight: 24, weight: 400 },
  },
  {
    id: "body-medium",
    label: "Body medium (.body--medium)",
    tag: "p",
    className: "body--medium",
    sample: "Senior Product Designer",
    source: "src/app/globals.css (body--medium) / project-card.tsx:78, about-section.tsx:101",
    audit: [],
  ...
  },
  {
    ...
    audit: [],
    mobile: { font: "Inter Tight", size: 14, lineHeight: 24, weight: 400 },
    desktop: { font: "Inter Tight", size: 14, lineHeight: 24, weight: 400 },
  },
  {
    id: "tag",
    label: "Tag (.tag)",
  ...
  },
  {
    ...
    mobile: { font: "Stick No Bills", size: 12, lineHeight: 16, weight: 500, transform: "uppercase", letterSpacing: "0.03em" },
    desktop: { font: "Stick No Bills", size: 12, lineHeight: 16, weight: 500, transform: "uppercase", letterSpacing: "0.03em" },
  },
  {
    id: "handwritten",
